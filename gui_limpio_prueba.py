...
# [PRUEBA LIMPIA] Sin check_actualizaciones (sin urllib/red)
...
def aplicar_tarea(hora):
    # [PRUEBA LIMPIA] Sin schtasks: NO crea tarea programada en esta prueba
    # para aislar si la creacion de tarea es lo que los antivirus marcan.
    return True
...
def main():
    cfg = cargar_config()
    # [PRUEBA LIMPIA] Sin verificacion de actualizaciones por red
    ...
    # [PRUEBA LIMPIA] Sin revisar actualizaciones al abrir
